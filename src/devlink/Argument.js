...
import _styles from "./Argument.module.css";
...
export function Argument({
  ...
  cardTitle = "Les salles Keep Cool à Lyon : l'endroit idéal pour s'entraîner en toute convivialité",
  cardContent = "Les salles de sport Keep Cool à Lyon offrent une expérience unique pour tous ceux qui souhaitent pratiquer une ac tivité physique dans un environnement agréable et convivial. Que vous soyez débutant ou athlète confirmé, les salles Keep Cool répondent à tous vos besoins en matière de fitness.",
  cardDisplay = true,
}) {
  ...
  return cardDisplay ? (
    <_Component
      className={_utils.cx(_styles, "card-arguments")}
      tag="div"
      card-fade-up=""
    >
      <_Builtin.Block
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "btn-icon", "is-large", "text-primary")}
          tag="div"
        >
          {""}
        </_Builtin.Block>
        <_Builtin.Heading
          className={_utils.cx(_styles, "club-group-argument-card-title")}
          tag="h3"
        >
          {cardTitle}
        </_Builtin.Heading>
