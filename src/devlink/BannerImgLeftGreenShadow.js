...
import _styles from "./BannerImgLeftGreenShadow.module.css";
...
export function BannerImgLeftGreenShadow({
  ...
  shortName = "OFFRES D’ESSAI",
  title = "SESSION OFFERTE AVEC UN COACH",
  text = "L’essentiel pour nous, c’est vous !",
  image = "https://cdn.prod.website-files.com/66fd42536fe9bf422a5a3aac/66fd42536fe9bf422a5a3b64_Keepcool.webp",
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "bannerimgleft")}
      grid={{
        type: "section",
      }}
      tag="section"
      ...
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        ...
        >
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-ec44498f-6140-9511-4a06-c0a340ea714c-40ea7148"
            )}
            tag="div"
          >
            <_Builtin.HFlex
            ...
            <_Builtin.Heading
              className={_utils.cx(_styles, "text-h1-d", "r-xl-text-h0-d")}
              tag="h1"
              heading-text-split=""
            >
              {title}
