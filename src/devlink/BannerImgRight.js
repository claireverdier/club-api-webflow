...
import _styles from "./BannerImgRight.module.css";
...
export function BannerImgRight({
  as: _Component = _Builtin.Section,
  headline = "CONCEPT > POURQUOI KEEPCOOL ?",
  title = "Pourquoi Keepcool ?",
  subTitle = "L’essentiel pour nous, c’est vous !",
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "bannerimgright")}
      grid={{
        type: "section",
      }}
      tag="section"
    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        <_Builtin.Block
          className={_utils.cx(_styles, "banner-ttc-container")}
          tag="div"
        >
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-_5e3af4a9-95cb-874c-0243-6b90bd8cb8df-bd8cb8dc"
            )}
            tag="div"
          >
            <_Builtin.HFlex
          ...
          <_Builtin.Image
            ...
            height="auto"
            card-fade-up=""
            alt="un groupe de personnes assises sur des tapis de yoga dans une pièce"
            src="https://cdn.prod.website-files.com/66fd42536fe9bf422a5a3aac/66fd42536fe9bf422a5a3b64_Keepcool.webp"
          />
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
