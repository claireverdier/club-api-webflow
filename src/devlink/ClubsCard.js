...
import _styles from "./ClubsCard.module.css";
...
export function ClubsCard({
  ...
  cardTitle = "Club",
  cardAddress = "Adresse",
  cardPostalCode = "Code Postal",
  cardFirstButtonText = "Button 1",

  cardFirstButtonLink = {
    href: "#",
  },

  cardSecondButtonText = "",

  cardSecondButtonLink = {
    href: "#",
  },
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "card-club")}
      tag="div"
      text-fade-up=""
    >
      <_Builtin.Image
        className={_utils.cx(_styles, "card-club-cover")}
        loading="lazy"
        width="auto"
        height="auto"
        alt=""
      ...
      />
      <_Builtin.Block
        className={_utils.cx(_styles, "card-club-infos", "_w-full")}
        tag="div"
      >
        <_Builtin.Link
        ...
        >
          ...
          <_Builtin.Block
            ...
            tag="div"
          >
            <_Builtin.Block tag="div">{cardAddress}</_Builtin.Block>
            <_Builtin.Block tag="div">{cardPostalCode}</_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Link>
        <_Builtin.Block
        ...
        >
          <_Builtin.Link
            ...
            button={false}
            data-qcd="aHR0cHM6Ly9zdWJzY3JpYmUua2VlcGNvb2wuZnIv"
            block="inline"
            options={{
              href: "#",
            }}
          ...
          <_Builtin.Link
            ...
            button={false}
            block="inline"
            options={cardSecondButtonLink}
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "xs-d-none")}
              tag="div"
            >
              {"En savoir"}
            </_Builtin.Block>
            <_Builtin.Block tag="div">{"plus"}</_Builtin.Block>
          </_Builtin.Link>
        </_Builtin.Block>
      </_Builtin.Block>
