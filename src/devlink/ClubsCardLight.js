...
import _styles from "./ClubsCardLight.module.css";
...
export function ClubsCardLight({
  as: _Component = _Builtin.Link,
  cardTitle = "Amiens Centre",
  address = "21 rue des Capucins 80100 Abbeville",
  cardCover = "https://cdn.prod.website-files.com/66fd42536fe9bf422a5a3aac/66fd42536fe9bf422a5a3b5a_artcile-keepcool.jpg",
  postalCode = "",
  city = "",
  ...
  return (
    ...
    >
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "d-flex-dir-col_gap-1", "p-6", "_w-full")}
        tag="div"
      >
        ...
        <_Builtin.Block className={_utils.cx(_styles, "text-medium")} tag="div">
          ...
          <_Builtin.Block
            ...
            tag="div"
          >
            <_Builtin.Block tag="div">{postalCode}</_Builtin.Block>
            <_Builtin.Block tag="div">{city}</_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
