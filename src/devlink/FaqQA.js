...
import _styles from "./FaqQA.module.css";
...
export function FaqQA({
  ...
  return (
    <_Component
      ...
      data-w-id="8a53c685-e9e6-d562-80f6-3eab6df5a165"
      tag="div"
      categorie={categorie}
      text-fade-up=""
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "d-flex-ali-cen-cen", "_w-full")}
        tag="div"
      >
        <_Builtin.Heading
          className={_utils.cx(_styles, "text-h5", "cursor-pointer")}
          tag="h3"
        >
          {question}
        </_Builtin.Heading>
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "btn-icon", "show-faq")}
            tag="div"
          >
            {""}
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "btn-icon", "hide-faq")}
            tag="div"
          >
            {""}
          </_Builtin.Block>
      ...
      >
        <_Builtin.RichText
          className={_utils.cx(_styles, "pt-7", "text-medium")}
          tag="div"
          slot=""
        >
          {answer}
