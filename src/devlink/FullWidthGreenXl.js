...
import _styles from "./FullWidthGreenXl.module.css";
...
export function FullWidthGreenXl({
  as: _Component = _Builtin.Section,
  cardHeadline = "OFFRE SPÉCIALE",
  cardTitle = "REJOINS UNE COMMUNAUTÉ EN MOUVEMENT DÈS 9,99€/MOIS !",
  cardDescription = "KeepCool, votre social sport club. Entraînez-vous, progressez et tissez des liens dans une communauté bienveillante, quel que soit votre niveau.",
  firstButtonVisibility = true,
  firstButtonText = "J’en profite",

  firstButtonLink = {
    href: "#",
  },

  lienDuPremierBoutonUrlEncodeeEnBase64SiLienExterne,
  secondButtonVisibility = false,
  secondButtonText = "Je m’abonne !",

  secondButtonLink = {
    href: "#",
  },

  lienDuDeuxemeBoutonUrlEncodeeEnBase64SiLienExterne,
  thirdButtonVisibility = true,
  thirdButtonText = "Voir toutes les offres",

  thirdButtonLink = {
    href: "#",
  },

  lienDuTroisiemeBoutonUrlEncodeeEnBase64SiLienExterne,
}) {
      ...
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        ...
        >
          ...
          >
            ...
            <_Builtin.Paragraph
              className={_utils.cx(_styles, "md-text-body-2")}
            >
              {cardDescription}
            </_Builtin.Paragraph>
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "d-flex-gap-4", "r-md-dir-col")}
            tag="div"
          >
            {firstButtonVisibility ? (
              <_Builtin.Block
                ...
                tag="div"
                data-qcd={lienDuPremierBoutonUrlEncodeeEnBase64SiLienExterne}
              >
                <_Builtin.HFlex
            ...
            {secondButtonVisibility ? (
              <_Builtin.Block
                ...
                tag="div"
                data-qcd={lienDuDeuxemeBoutonUrlEncodeeEnBase64SiLienExterne}
              >
                <_Builtin.Block tag="div">{secondButtonText}</_Builtin.Block>
                <_Builtin.HtmlEmbed value="%3Cscript%20type%3D%22text%2Fjavascript%22%3E%0Adocument.addEventListener(%22DOMContentLoaded%22%2C%20function(event)%20%7B%0A%09var%20classname%20%3D%20document.getElementsByClassName(%22js--btn-obfuscated%22)%3B%0A%20%20console.log(classname)%3B%0A%09for%20(var%20i%20%3D%200%3B%20i%20%3C%20classname.length%3B%20i%2B%2B)%20%7B%0A%09%09console.log(classname%5Bi%5D)%3B%0A%09%09classname%5Bi%5D.addEventListener(%22click%22%2C%20myFunction%2C%20false)%3B%0A%09%09%2F%2Fclick%20droit%0A%09%09classname%5Bi%5D.addEventListener(%22contextmenu%22%2C%20myRightFunction%2C%20false)%3B%0A%09%7D%20%0A%7D)%3B%0A%2F%2Ffonction%20du%20click%20gauche%0Avar%20myFunction%20%3D%20function(event)%20%7B%0A%09var%20attribute%20%3D%20this.getAttribute(%22data-qcd%22)%3B%0A%20%20console.log(attribute)%3B%0A%09%09if(event.ctrlKey)%20%7B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%09%09%20var%20newWindow%20%3D%20window.open(decodeURIComponent(window.atob(attribute))%2C%20%22_blank%22)%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%09%09%20newWindow.focus()%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%09%7D%20else%20%7B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%09%09%20document.location.href%3D%20decodeURIComponent(window.atob(attribute))%3B%0A%09%09%09%7D%20%0A%09%7D%3B%0A%2F%2Ffonction%20du%20click%20droit%0Avar%20myRightFunction%20%3D%20function(event)%20%7B%0A%09var%20attribute%20%3D%20this.getAttribute(%22data-qcd%22)%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09if(event.ctrlKey)%20%7B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%09%20var%20newWindow%20%3D%20window.open(decodeURIComponent(window.atob(attribute))%2C%20%22_blank%22)%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%09%20newWindow.focus()%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09%7D%20else%20%7B%20%20%20%20%20%20%0A%09%09%09%20window.open(decodeURIComponent(window.atob(attribute))%2C%22_blank%22)%3B%09%0A%09%09%7D%0A%7D%20%0A%3C%2Fscript%3E" />
              </_Builtin.Block>
            ) : null}
            {thirdButtonVisibility ? (
              <_Builtin.Block
                ...
                tag="div"
                data-qcd={lienDuTroisiemeBoutonUrlEncodeeEnBase64SiLienExterne}
              >
