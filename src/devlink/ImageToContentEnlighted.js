...
import _styles from "./ImageToContentEnlighted.module.css";
...
export function ImageToContentEnlighted({
  as: _Component = _Builtin.Section,
  image = "https://cdn.prod.website-files.com/66fd42536fe9bf422a5a3aac/66fd42536fe9bf422a5a3b59_illustration.webp",
  headline = "Headline",
  title = "Titre",
  content = "Nos coachs, experts sportifs, vous emmèneront vers une pratique sportive positive et décomplexée, adaptée à votre rythme.",
  chipsList,
  chipsListVisibility = false,
      ...
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        ...
        >
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-_90101ef9-ce5e-790e-4e36-fc67e162d833-e162d830"
            )}
            tag="div"
          >
            <_Builtin.Image
              className={_utils.cx(_styles, "img-drop-shadow", "_w-full")}
              loading="lazy"
              width="Auto"
              height="auto"
              card-fade-up=""
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-_90101ef9-ce5e-790e-4e36-fc67e162d835-e162d830"
            )}
            tag="div"
          >
            <_Builtin.Block
            ...
            >
              ...
              >
                ...
                <_Builtin.Paragraph
                  className={_utils.cx(_styles, "max-w-700", "text-light")}
                  text-fade-up=""
                >
                  {content}
                </_Builtin.Paragraph>
