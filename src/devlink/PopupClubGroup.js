...
import _styles from "./PopupClubGroup.module.css";

export function PopupClubGroup({ as: _Component = _Builtin.Block }) {
  return (
    <_Component
          ...
          >
            ...
            >
              <_Builtin.DOM
                ...
                slot=""
                type="hidden"
                value="KeepCool Site Popup : Session Offerte"
                name="campaign"
                id="campaign-id-field"
              />
              <_Builtin.DOM
                tag="input"
                slot=""
