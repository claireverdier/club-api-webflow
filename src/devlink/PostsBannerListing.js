...
import { PostsCardFeatured } from "./PostsCardFeatured";
import * as _utils from "./utils";
import _styles from "./PostsBannerListing.module.css";
...
export function PostsBannerListing({ as: _Component = _Builtin.Section }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "blogbanner")}
      grid={{
        type: "section",
      }}
      tag="section"
      ...
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        ...
        >
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-f6ba4a7c-93a0-9cb0-8d5c-a703fe9ea649-fe9ea646"
            )}
            tag="div"
          >
            <_Builtin.HFlex
            ...
            <_Builtin.Block
              ...
              tag="div"
            >
              {"Nos actus, conseils, astuces et interviews"}
            </_Builtin.Block>
          </_Builtin.Block>
